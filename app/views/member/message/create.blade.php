...
$tab = "2"; 
  ...
  <div style="height=auto" >
		<h3><center>Write Quick Message</center></h3><br />
                    {{Form::open(array('method'=>'post','action' => 'MessageController@store'))}}
      ...
      <tr>
        ...
        <td>{{ Form::text('to',null,array('id'=>'name','class'=>'form-control','placeholder'=>'Add reciepiants','required'=>'')) }}</td>
      ...
      <tr><td><h4>Message:</h4></td>
        <td><textarea name="msg_body" style="width:100%;height:125%"></textarea>
</td>
